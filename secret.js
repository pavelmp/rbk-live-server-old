...
module.exports.SECRET_KEY = process.env.SECRET_KEY || 'somestring';
module.exports.DATABASE_URL = process.env.DATABASE_URL || 'mysql://root:rbk@localhost:3306/rbkdatabase'
